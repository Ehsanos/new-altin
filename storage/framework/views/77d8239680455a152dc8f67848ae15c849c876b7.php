                    ...
                    <li class="nav-item d-block d-lg-none">
                        <div class="float-left float-md-right my-3 mt-md-0 search-area">
                            ...
                            <input class="float-left float-sm-right custom-search-input" type="search" name=""
                                   placeholder="Type to filter by address"></div>
                    </li>
                </ul>
                <?php if(Auth::check()): ?>
...
} elseif ($_instance->childHasBeenRendered('AMqHala')) {
    $componentId = $_instance->getRenderedChildComponentId('AMqHala');
    $componentTag = $_instance->getRenderedChildComponentTagName('AMqHala');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AMqHala');
} else {
    $response = \Livewire\Livewire::mount('counter', []);
    $html = $response->html();
    $_instance->logRenderedChild('AMqHala', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </span>
    ...
    <a href="https://wa.me/<?php echo e($setting->whatsapp1?? $setting->whatsapp2); ?>" class="floatbb" target="_blank">
    ...
    <footer class="footer">
        <div class="container py-4 py-lg-5">
            <div class="row row-cols-2 row-cols-md-4">
                <div class="col-12 col-md-4">
                    <div class="font-weight-bold text-lg-right d-flex align-items-center mb-2"><span
                            class="text-dark"><?php echo e(lang('emails')); ?></span></div>
                    <div class="pt-2">
                        <form method="post" action="<?php echo e(route('sub')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div>
                                <button class="btn btn-primary shadow btn-sign d-block w-100"
                                        type="submit"><?php echo e(lang('send')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-12 col-lg-4 text-lg-left d-flex flex-column">
                    <div class="p-3">
                        ...
                        <ul class="list-unstyled text-center text-lg-right">
                            <li><a href="<?php echo e(route('langs.index')); ?>"><?php echo e(lang('home')); ?></a></li>
                            <li><a href="<?php echo e(route('langs.products')); ?>"><?php echo e(lang('product')); ?></a></li>
                            <li><a href="<?php echo e(route('langs.catalog')); ?>"><?php echo e(lang('services')); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-lg-4 text-lg-left d-flex flex-column">
            ...
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                <p class="mb-0"><?php echo e(lang('rights')); ?> AlTinMIX </p>
