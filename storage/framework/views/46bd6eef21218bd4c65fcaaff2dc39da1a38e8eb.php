...
} elseif ($_instance->childHasBeenRendered('akWhOgE')) {
    $componentId = $_instance->getRenderedChildComponentId('akWhOgE');
    $componentTag = $_instance->getRenderedChildComponentTagName('akWhOgE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('akWhOgE');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('akWhOgE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
